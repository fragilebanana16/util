...
##    randPt = randPts[0]
    ...
    ##    print("coord1:{}\ncoord2:{}".format(coord1,coord2))
        ...
        euqation1 = lambda x:float(((x-coord1[0][0])*(coord1[1][1]-coord1[0][1])+0.0001)/\
    ...
    ##    print(coord1[0][0],euqation1(coord1[0][0]))
        # the second equation
        euqation2 = lambda x:float(((x-coord2[0][0])*(coord2[1][1]-coord2[0][1])+0.0001)/\
                                                    (coord2[1][0]-coord2[0][0]+0.0001)+coord2[0][1])
        # get x
        euqation2_2 = lambda y:float(((y-coord2[0][1])*(coord2[1][0]-coord2[0][0])+0.0001)/\
